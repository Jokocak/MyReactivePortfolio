    ...
    return (
        <div>
            ...
            <div className="description-box">
                ...
                <p>
                A dedicated payoff optimizer compares avalanche and snowball strategies against realistic cash-flow constraints and recommends a personalized path out of debt.
                </p>
            </div>
            ...
            <div className="result-box">
                <h4>Results</h4>
                <p>
                In benchmark scenarios, the payoff optimizer modeled meaningful reductions in total interest paid and shortened time-to-debt-free by months once cash-flow constraints were factored into the avalanche and snowball strategies. User data is isolated per account via row-level security policies across 10 Supabase Postgres tables, enforcing multi-tenant separation at the database layer.
                </p>
            </div>
